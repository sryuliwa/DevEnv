...
" Javascript
hi javaScriptLabel  guifg=#c5060b guibg=NONE gui=bold
hi javaScriptConstant  guifg=#6d79de guibg=NONE gui=bold

" Coffeescript
hi coffeeSpecialIdent guifg=#318495 guibg=NONE gui=bold
hi coffeeObject  guifg=#6d79de guibg=NONE gui=bold
hi coffeeConstant  guifg=#6d79de guibg=NONE gui=bold
hi coffeeObjAssign  guifg=#c5060b guibg=NONE gui=bold